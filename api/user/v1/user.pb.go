...
func (x *AddUserRequest) GetSex() string {
	if x != nil {
		return x.Sex
	}
	return ""
...
func (x *AddUserReply) GetCode() int32 {
	if x != nil {
		return x.Code
	}
	return 0
...
type FetchUsersReply struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Users []*FetchUsersReply_UserInfo `protobuf:"bytes,1,rep,name=users,proto3" json:"users,omitempty"`
}

func (x *FetchUsersReply) Reset() {
	*x = FetchUsersReply{}
	if protoimpl.UnsafeEnabled {
...
func (x *FetchUsersReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FetchUsersReply) ProtoMessage() {}

func (x *FetchUsersReply) ProtoReflect() protoreflect.Message {
	mi := &file_api_user_v1_user_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FetchUsersReply.ProtoReflect.Descriptor instead.
func (*FetchUsersReply) Descriptor() ([]byte, []int) {
	return file_api_user_v1_user_proto_rawDescGZIP(), []int{2}
}

func (x *FetchUsersReply) GetUsers() []*FetchUsersReply_UserInfo {
	if x != nil {
		return x.Users
	}
	return nil
...
type FetchUsersReply_UserInfo struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *FetchUsersReply_UserInfo) Reset() {
	*x = FetchUsersReply_UserInfo{}
	if protoimpl.UnsafeEnabled {
...
func (x *FetchUsersReply_UserInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FetchUsersReply_UserInfo) ProtoMessage() {}

func (x *FetchUsersReply_UserInfo) ProtoReflect() protoreflect.Message {
	mi := &file_api_user_v1_user_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FetchUsersReply_UserInfo.ProtoReflect.Descriptor instead.
func (*FetchUsersReply_UserInfo) Descriptor() ([]byte, []int) {
	return file_api_user_v1_user_proto_rawDescGZIP(), []int{2, 0}
}

func (x *FetchUsersReply_UserInfo) GetId() int32 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *FetchUsersReply_UserInfo) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *FetchUsersReply_UserInfo) GetSex() string {
	if x != nil {
		return x.Sex
	}
	return ""
...
func (x *FetchUsersReply_UserInfo) GetAge() int32 {
	if x != nil {
		return x.Age
	}
	return 0
...
var file_api_user_v1_user_proto_rawDesc = []byte{
	...
	0x31, 0x22, 0x48, 0x0a, 0x0e, 0x41, 0x64, 0x64, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75,
	...
	,
	...
	0x04, 0x20, 0x01, 0x28, 0x05, 0x52, 0x03, 0x61, 0x67, 0x65, 0x22, 0x0e, 0x0a, 0x0c, 0x45, 0x6d,
	0x70, 0x74, 0x79, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x32, 0x7f, 0x0a, 0x04, 0x55, 0x73,
	0x65, 0x72, 0x12, 0x39, 0x0a, 0x07, 0x41, 0x64, 0x64, 0x55, 0x73, 0x65, 0x72, 0x12, 0x17, 0x2e,
	...
	0x2e, 0x41, 0x64, 0x64, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x3c, 0x0a,
	0x09, 0x46, 0x65, 0x74, 0x63, 0x68, 0x55, 0x73, 0x65, 0x72, 0x12, 0x15, 0x2e, 0x75, 0x73, 0x65,
	0x72, 0x2e, 0x76, 0x31, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67,
	0x65, 0x1a, 0x18, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x2e, 0x46, 0x65, 0x74, 0x63,
	0x68, 0x55, 0x73, 0x65, 0x72, 0x73, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x42, 0x1c, 0x5a, 0x1a, 0x68,
	0x6f, 0x6d, 0x65, 0x77, 0x6f, 0x72, 0x6b, 0x5f, 0x77, 0x65, 0x65, 0x6b, 0x34, 0x2f, 0x61, 0x70,
...
var file_api_user_v1_user_proto_goTypes = []interface{}{
	...
	(*AddUserReply)(nil),             // 1: user.v1.AddUserReply
	(*FetchUsersReply)(nil),          // 2: user.v1.FetchUsersReply
	(*EmptyMessage)(nil),             // 3: user.v1.EmptyMessage
	(*FetchUsersReply_UserInfo)(nil), // 4: user.v1.FetchUsersReply.UserInfo
}
var file_api_user_v1_user_proto_depIdxs = []int32{
	4, // 0: user.v1.FetchUsersReply.users:type_name -> user.v1.FetchUsersReply.UserInfo
	0, // 1: user.v1.User.AddUser:input_type -> user.v1.AddUserRequest
	3, // 2: user.v1.User.FetchUser:input_type -> user.v1.EmptyMessage
	1, // 3: user.v1.User.AddUser:output_type -> user.v1.AddUserReply
	2, // 4: user.v1.User.FetchUser:output_type -> user.v1.FetchUsersReply
...
func file_api_user_v1_user_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_api_user_v1_user_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*FetchUsersReply_UserInfo); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
...
type UserClient interface {
	...
	FetchUser(ctx context.Context, in *EmptyMessage, opts ...grpc.CallOption) (*FetchUsersReply, error)
}
...
func (c *userClient) FetchUser(ctx context.Context, in *EmptyMessage, opts ...grpc.CallOption) (*FetchUsersReply, error) {
	out := new(FetchUsersReply)
	err := c.cc.Invoke(ctx, "/user.v1.User/FetchUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServer interface {
	...
	FetchUser(context.Context, *EmptyMessage) (*FetchUsersReply, error)
}
...
func (*UnimplementedUserServer) FetchUser(context.Context, *EmptyMessage) (*FetchUsersReply, error) {
...
func _User_FetchUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/user.v1.User/FetchUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).FetchUser(ctx, req.(*EmptyMessage))
	}
	return interceptor(ctx, in, info, handler)
}
